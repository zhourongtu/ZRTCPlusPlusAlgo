https://blog.csdn.net/weixin_43269726/article/details/105173657
...
// 最终肯定是n-k位
// 1.找到当前最小的位数，如果在第k位及以内，则删除前面的数且递归往后
// 2.如果在第k位以外，在前k位找最小的值，删除前面的值，递归往后。
